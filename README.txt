...
-----------------------
 ...
 - Advice clarification - labelIDs in defaults must match the labelID the script would generate for the label of the shortcut. See "Providing default shortcuts" below.
 - Advance warning - In an upcoming build, the labelID property will be removed from the xml data files. Existing labelID properties will then be ignored.
...
Important - If you provide a labelID element, its value MUST match the labelID that would be generated by the script for the shortcuts label. Failure to do this will cause issues. See "labelID and defaultID.txt" for details of what labelID the script will generate.

Please note, the labelID element is not intended to be provided in defaults, and will stop functioning in all xml files in an upcoming revision.
